...
public class PreCompThread {
	...
	public static void main(String[] args) throws Exception {
		...
		TileBuffer buffer = new MainMemoryTileBuffer(0, null);
	...
	public static class FetchTileServlet extends HttpServlet {
		...
		protected void updateAccuracy(NewTileKey id) {
			//TODO: fix this
			//predictionEngine.updateAccuracy(id);
		}
		
		protected void doReset(String useridstr,String modelstr,String predictions,
				String nstr,String usePhases) throws Exception {
				System.out.println("Doing reset...");
				predictionEngine.reset(useridstr.split("_"),modelstr.split("_"),
						predictions.split("_"), nstr,true);
				cacheManager.clear();
		}
		...
		protected void doReset(HttpServletRequest request,
			...
			try {
				doReset(useridstr,modelstr,predictions,nstr,usePhases);
			} catch (Exception e) {
		...
		protected ColumnBasedNiceTile fetchTile(String tile_id, String zoom,
			...
			t = cacheManager.retrieveRequestedTile(key);
			return t;
		}
