...
// returns the actual FC vis object, needed by the tile manager, as well as
// the jquery object (a new div) containing the rendered visualization.
...
ForeCache.Renderer.Vis.getVis = function(root,options) {
  ...
  return {"visObj": graph, "visDiv":visDiv};
};
