...
public class MimicMainThread {
	public static MimicWaveformViewFactory mvf;
	...
	public static void main(String[] args) throws Exception {
		...
		mvf = new MimicWaveformViewFactory();
		TileStructure ts = MimicWaveformTileStructureFactory.
				getDefaultMimicWaveformTileStructure();
		NewTileInterface nti = new Scidb13_3IqueryTileInterface();
		dtv = new DefinedTileView(null, ts, nti, defaultSigmapFilename,
	...
	public static class FetchTileServlet extends HttpServlet {
		...
		protected void doReset(String taskname, String useridstr,
				...
				asm = MimicAllocationStrategyMapFactory.
		...
		// frontend must issue a reset request before requesting tiles
		protected void doReset(HttpServletRequest request,
			...
			try {
				// get the appropriate view for this record
				dtv.v = mvf.getMimicWaveformView(recordName);
			} catch (Exception e1) {
