...
public class FilteredHistogramSignatureModel {
	...
	public FilteredHistogramSignatureModel(TileHistoryQueue ref, MemoryTileBuffer membuf, DiskTileBuffer diskbuf,ScidbTileInterface api) {
	...
	public List<DirectionPrediction> predictOrder(List<UserRequest> htrace) throws Exception {
		...
		for(Direction d : Direction.values()) {
			...
			dp.confidence = 0.0;
			if(candidate != null) {
				dp.confidence = orig.getFilteredHistogramDistance(candidate);
